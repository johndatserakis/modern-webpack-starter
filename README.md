...
A modern JavaScript frontend using [Webpack](https://github.com/webpack/webpack) built from scratch. You can view the demo [here](http://modern-webpack-starter.innermonkdesign.com/).
